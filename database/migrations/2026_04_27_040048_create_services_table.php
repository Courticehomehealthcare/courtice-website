...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->string('bannervideourl', 255)->nullable();
            $table->string('youtubevideo', 150)->nullable();
            $table->string('bannertitle', 200)->nullable();
            $table->string('pagecategory', 100);
            $table->string('pagesubcategory', 200)->nullable();
            ...
            $table->string('serviceimage', 255)->nullable();
