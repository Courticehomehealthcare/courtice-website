...
@section('title', 'Online Shopping || Careon')
@php
    ...
    <section class="page-header" style="background-image: url({{ asset('assets/images/backgrounds/page-header-bg.jpg') }});">
        <div class="container">
            <div class="page-header__inner">
                <h2>{{ $landingService->ServicesTitle ?? 'Online Shopping' }}</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="section-title-three sec-title-animation animation-style2">
                        <h3 class="section-title-three__title title-animation">{{ $landingService->ServicesTitle ?? 'Our Online Services' }}</h3>
                        @if(isset($landingService))
                            <div class="mt-3">
                                {!! $landingService->ServicesText !!}
                            </div>
                        @else
                            <p class="mt-3">Shop from the comfort of your home with our extensive online catalog and shipping options.</p>
                        @endif
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-12 text-center">
                            <p>No specific online services found at the moment. Please check our main shop.</p>
                            <a href="{{ route('collections') }}" class="thm-btn mt-3">Go to Shop <span class="icon-plus"></span></a>
                        </div>
                        @endforelse
                    </div>
                </div>
