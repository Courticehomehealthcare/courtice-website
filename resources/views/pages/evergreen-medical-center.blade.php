...
@section('title', 'Evergreen Medical Center || Careon || Careon Laravel Template')
@php
...
@php
    ...
    $subtitle = 'Evergreen Medical Center';
@endphp
@section('content')
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        <div class="service-details__img">
                            <img src="{{ asset("/assets/images/resources/service-details-img-5.jpg") }}" alt="">
                        </div>
