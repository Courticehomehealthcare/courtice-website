...
@section('title', 'WellSpring Wellness Center || Careon || Careon Laravel Template')
@php
...
@endphp
@php
    $title = 'WellSpring Wellness Center';
    $subtitle = 'WellSpring Wellness Center';
@endphp
@section('content')
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        <div class="service-details__img">
                            <img src="{{ asset("/assets/images/resources/service-details-img-2.jpg") }}" alt="">
                        </div>
