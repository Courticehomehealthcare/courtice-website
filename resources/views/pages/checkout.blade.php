...
@section('title', 'Checkout || Careon || Careon Laravel Template')
@php
                    ...
                    <div class="col-xl-8 col-lg-6">
                        <div class="billing_details">
                            <div class="billing_title">
                                <p>Returning Customer? <a href="{{ url("#") }}">Click here to Login</a></p>
                            ...
                            <div class="sidebar-order-summary__bottom">
                                ...
                                <div class="sidebar-order-summary__checked">
                                    ...
                                    <label for="skipper2"><span></span>I have read and agree to the website <a
                                            href="{{ url("#") }}">terms and conditions</a></label>
                                </div>

                                <div class="sidebar-order-summary__btn">
                                    <a class="thm-btn" href="{{ url("about") }}">Place your order
                                        <span class="icon-right-arrow"></span>
                                    </a>
                                </div>
                            </div>
