...
@section('title', 'PureLife Health Services || Careon || Careon Laravel Template')
@php
...
@endphp
@php
    $title = 'PureLife Health Services';
    $subtitle = 'PureLife Health Services';
@endphp
@section('content')
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        <div class="service-details__img">
                            <img src="{{ asset("/assets/images/resources/service-details-img-3.jpg") }}" alt="">
                        </div>
