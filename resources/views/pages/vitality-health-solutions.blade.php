...
@section('title', 'Vitality Health Solutions || Careon || Careon Laravel Template')
@php
...
@endphp
@php
    $title = 'Vitality Health Solutions';
    $subtitle = 'Vitality Health Solutions';
@endphp
@section('content')
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        <div class="service-details__img">
                            <img src="{{ asset("/assets/images/resources/service-details-img-1.jpg") }}" alt="">
                        </div>
